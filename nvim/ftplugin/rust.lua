...
vim.keymap.set('n', ',de', function() vim.cmd.RustLsp('explainError') end, desc('[r]ust: [e]xplain error'))
vim.keymap.set('n', ',dR', function() vim.cmd.RustLsp('renderDiagnostic') end, desc('rust: [r]ender [d]iagnostic'))
vim.keymap.set('n', ',dr', function() vim.cmd.RustLsp('relatedDiagnostics') end, desc('rust: [g]o to related [d]iagnostics'))
